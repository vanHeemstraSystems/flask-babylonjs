...
@shot_type_bp.route('/new', methods=['GET', 'POST']) 
def new_shot_type():
    form = ShotTypeForm()
...
@shot_type_bp.route('/edit/<int:shot_type_id>', methods=['GET', 'POST']) 
...
@shot_type_bp.route('/delete/<int:shot_type_id>', methods=['POST']) 
