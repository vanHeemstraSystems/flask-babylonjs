...
@shot_type_bp.route('/shot_types/new', methods=['GET', 'POST']) 
def new_shot_type():
    form = ShotTypeForm()
...
@shot_type_bp.route('/shot_types/edit/<int:shot_type_id>', methods=['GET', 'POST']) 
def edit_shot_type(shot_type_id):
...
@shot_type_bp.route('/shot_types/delete/<int:shot_type_id>', methods=['POST']) 
def delete_shot_type(shot_type_id):
    shot_type = ShotType.query.get_or_404(shot_type_id)
