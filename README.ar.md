...
افتح عنوان URL هذا باستخدام`https://github.dev/` instead of `https://github.com/`لاستخدام IDE المستند إلى الويب لـ Visual Studio Code.
