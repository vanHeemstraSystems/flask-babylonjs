...
9) Set SQLAlchemy Track Modifications: `(.venv) $ export SQLALCHEMY_TRACK_MODIFICATIONS=True`10) Définir la clé secrète :`(.venv) $ export SECRET_KEY=********`
11) Run the flask app: `(.venv) $ flask run`12) Ouvrez l'interface Web comme vous y êtes invité
