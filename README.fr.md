...
1) Entrez`flask_app`annuaire:`$ cd flask_app`2) S'il n'existe pas, créez un environnement virtuel à l'intérieur du`flask_app` directory: `$ python3 -m venv .venv`(macOS :`$ virtualenv .venv`)
